    ...
    <div class="wrap egoi4wp-settings">
        <div class="row">
            ...
            <div class="main-content col col-12" style="margin:0 0 20px;">
                ...
                <p class="label_text"><?php _e('This plugin is integrated with Multibanco (euPago, Ifthenpay, easypay, Hipay Compra Facil), Payshop (euPago), WooCommerce PagSeguro', 'smart-marketing-addon-sms-order');?></p>
